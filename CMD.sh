...
nohup python train_mlp.py --name=note1 --dataset=crosstask_how --gpu=2 --epochs=160 \
      --num_heads=4 --num_layers=2 --dim_feedforward=1024 --dropout=0.1 > out/output_note1.log 2>&1 &
nohup python train_mlp.py --name=note2 --dataset=crosstask_how --gpu=3 --epochs=160 \
      --num_heads=4 --num_layers=2 --dim_feedforward=1024 --dropout=0.2 > out/output_note2.log 2>&1 &
nohup python train_mlp.py --name=note3 --dataset=crosstask_how --gpu=2 --epochs=160 \
      --num_heads=4 --num_layers=2 --dim_feedforward=1024 --dropout=0.3 > out/output_note3.log 2>&1 &
nohup python train_mlp.py --name=note4 --dataset=crosstask_how --gpu=3 --epochs=160 \
      --num_heads=4 --num_layers=2 --dim_feedforward=1024 --dropout=0.4 > out/output_note4.log 2>&1 &
nohup python train_mlp.py --name=note5 --dataset=crosstask_how --gpu=4 --epochs=160 \
      --num_heads=4 --num_layers=2 --dim_feedforward=1024 --dropout=0.5 > out/output_note5.log 2>&1 &
nohup python train_mlp.py --name=note6 --dataset=crosstask_how --gpu=5 --epochs=160 \
      --num_heads=4 --num_layers=2 --dim_feedforward=1024 --dropout=0.6 > out/output_note6.log 2>&1 &
nohup python train_mlp.py --name=note7 --dataset=crosstask_how --gpu=6 --epochs=160 \
      --num_heads=4 --num_layers=2 --dim_feedforward=1024 --dropout=0.7 > out/output_note7.log 2>&1 &
nohup python train_mlp.py --name=note8 --dataset=crosstask_how --gpu=6 --epochs=160 \
      --num_heads=4 --num_layers=2 --dim_feedforward=1024 --dropout=0.8 > out/output_note8.log 2>&1 &
nohup python train_mlp.py --name=note9 --dataset=crosstask_how --gpu=5 --epochs=160 \
...
nohup python train_mlp.py --name=note2 --dataset=coin --gpu=6  --epochs=160 > out/output_note2.log 2>&1 &
...
python temp.py --num_thread_reader=1 --resume --dataset=crosstask_how \
       ...
       --num_heads=4 --num_layers=2 --dim_feedforward=1024 --dropout=0.9 \
       --ckpt_path=/home/zhouyufan/Projects/PDPP/save_max_mlp/epoch_note9_0160.pth.tar --gpu=6
