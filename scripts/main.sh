...
python main_distributed.py --dataset=crosstask_how --name=how1 --gpu=1 \
      --base_model=base


nohup python main_distributed.py --dataset=NIV --name=NIV1 --gpu=2 \
      --base_model=base --epochs=400 > out/output_NIV1.log 2>&1 &
